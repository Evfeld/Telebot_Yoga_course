...
elif today.strftime('%Y-%m-%d') == '2023-10-19':
...
elif today.strftime('%Y-%m-%d') == '2023-10-20':
...
elif today.strftime('%Y-%m-%d') == '2023-10-21':
